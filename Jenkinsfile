pipeline {
  ...
  environment {
    ...
    EXT_USER = 'ungoogled-software'
    EXT_REPO = 'ungoogled-chromium-portablelinux'
    BUILD_VERSION_ARG = 'UGC_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-ungoogled-chromium'
    CONTAINER_NAME = 'ungoogled-chromium'
    DOCKERHUB_IMAGE = 'linuxserver/ungoogled-chromium'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-ungoogled-chromium/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-ungoogled-chromium\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-ungoogled-chromium\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Ungoogled-chromium\" \
          --label \"org.opencontainers.image.description=[Ungoogled Chromium](https://github.com/ungoogled-software/ungoogled-chromium) is Google Chromium, sans dependency on Google web services.\" \
