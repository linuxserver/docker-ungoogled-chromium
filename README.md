...
<!-- Please read https://github.com/linuxserver/docker-ungoogled-chromium/blob/master/.github/CONTRIBUTING.md -->
...
docker run --rm -it \
  --shm-size=1gb \
  -p 3001:3001 \
  lscr.io/linuxserver/ungoogled-chromium:latest bash
```
...
| Parameter | Function |
| :----: | --- |
| `-p 3000:3000` | HTTP Ungoogled Chromium desktop gui, must be proxied. |
